...
2. Finding ppp and qqq

Using the modulus nnn and the offset formula, we iterated over potential values for ppp and checked if q=n/pq = n / pq=n/p was also prime.
...
Step 3.3: Calculating the Private Key ddd
Using the Extended Euclidean Algorithm, we computed the modular inverse of e mod (p−1)(q−1)(p-1)(q-1)(p−1)(q−1), giving us d, the private key.
python
def inverse(e, phi):
    def gcd(a, b):
        if b == 0:
...
# Provided values
n = int("")
e = 65537
